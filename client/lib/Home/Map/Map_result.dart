...
class MapResult extends StatefulWidget {
  ...
  @override
  State<MapResult> createState() => MapResultState();
}

class MapResultState extends State<MapResult> {
            ...
            itemBuilder: (BuildContext context, int index) {
              return Padding(
                ...
                child: _boxes(
                    ...
                    widget.data[index]['address'].length > 35 ? widget.data[index]['address'].substring(0,35)+'\n'+ widget.data[index]['address'].substring(35): widget.data[index]['address'],
  ...
  Widget _boxes(String _image, double lat,double long,String Name,String address,int star,String openday,String opentime) {
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: myDetailsContainer1(Name,openday,opentime,star,address),
                    ),
                  ),
  ...
  Widget myDetailsContainer1(String Name,String openday, String opentime,int star,String address) {
    return Column(
