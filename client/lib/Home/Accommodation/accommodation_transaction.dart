...
class AccommodationTransaction extends StatefulWidget {
  ...
  @override
  _AccommodationTransactionState createState() => _AccommodationTransactionState();
}
                        ...
                        child: Wrap(
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Wrap(
                                children: <Widget>[
                                  const Icon(Icons.receipt_long_rounded, color: Color(0xff1D3557)),
                                  const SizedBox(width: 5),
                                  Text(
                                    'ยกเลิกการจองฟรีจนถึงวันที่ ' + checkInEdit.text,
                                    style: const TextStyle(
                                      color: Color(0xff1D3557),
                                      fontSize: 14
                                    ),
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Container(
                                padding: const EdgeInsets.symmetric(horizontal: 10),
                                child: const Icon(Boxicons.bxl_visa, color: Color(0xff1D3557), size: 60),
                              ),
                              Flexible(
                                child: Container(
                  ...
                  Form(
                    ...
                    child: Column(
                      children: [
                        Stack(
                          children: <Widget>[
                            IconButton(
                              ...
                              constraints: const BoxConstraints(),
                              icon: const Icon(Icons.close_rounded, color: Color(0xffFFF4DC), size: 30)
                            ),
                            const Padding(
                        ...
                        Container(
                          padding: EdgeInsets.only(top: 20, right: 15, bottom: MediaQuery.of(context).viewInsets.bottom, left: 15),
                          child: Column(
                            children: [
                              TextFormField(
                                focusNode: userNameFocusNode,
                                controller: userName,
                                style: const TextStyle(color: Color(0xffECFAFF)),
                                decoration: const InputDecoration(
                                  labelText: 'ชื่อ-นามสกุล',
                                  labelStyle: TextStyle(color: Color(0xffFFF4DC)),
                                  hintText: 'ชื่อ-นามสกุล ของผู้จอง',
                                  hintStyle: TextStyle(color: Color(0xffC4C4C4)),
                                  enabledBorder: UnderlineInputBorder(
                                      borderSide: BorderSide(color: Color(0xffFFF4DC))
                                  ),
                                ),
                                validator: (value) {
