                            ...
                            child: TextFormField(
                              ...
                              onTap: () async {
                                showMaterialNumberPicker(
                                  ...
                                  minNumber: 1,
                                  selectedNumber:
                                      int.parse(numberOfPeople.text),
                                  onChanged: (value) => setState(() =>
                                      numberOfPeople.text = value.toString()),
                                );
                              },
                            ),
                          ),
                            ...
                            child: TextFormField(
                              ...
                              onTap: () async {
                                showMaterialNumberPicker(
                                  ...
                                  onChanged: (value) => setState(() =>
                                      numberOfRooms.text = value.toString()),
                                );
                              },
                            ),
                          ),
