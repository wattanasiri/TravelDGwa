...
class flighthelp extends StatefulWidget {

  @override

  _flighthelpState createState() => _flighthelpState();
}

class _flighthelpState extends State<flighthelp> {
            ...
            children: [
              Row(
                children: [
                  Flexible(child:
                  Text(
                    "การช่วยเหลือเกี่ยวกับเที่ยวบิน",
                    maxLines: null,
                  ...
                  IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(
                            builder: (context) => bookflighthelp())
                        );
                      }
                  ),
                ],
